...
#define STRING_CONFIG_H_AUTHOR "(Marc Gollop, BigTreeTech 2-in-1)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 210.80
  #define DEFAULT_bedKi 40.81
  #define DEFAULT_bedKd 725.87
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, 00, -1 }
